 ...
 *
 *  Match upstream behavior: POST /wavex-os/onboarding/pillar/5/test-send
...
export function registerPillar5TestSendRoute(app: FastifyInstance): void {
  app.post("/wavex-os/onboarding/pillar/5/test-send", async (req: FastifyRequest, reply: FastifyReply) => {
