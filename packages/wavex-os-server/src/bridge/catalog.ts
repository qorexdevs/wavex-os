/** Catalog helpers — translate wavex-os's 33 base-roster slots into the
 *  wavex agent-templates registry + the ergonomics the dashboard needs.
 *
 *  Slot taxonomies:
 *    - wavex-os "slot" = dotted operational handle (e.g. cpo.build, cro.outbound)
...
/** Look up the wavex template id for an wavex-os slot. Falls back to the
