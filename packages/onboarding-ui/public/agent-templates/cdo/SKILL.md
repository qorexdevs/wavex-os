---
name: cdo
description: cdo role template (WaveX-authored, derived from session 2026-05-05/06 patterns)
origin: wavex
role: cdo
tier: 2
division: c-suite
defaultKpis: ["kpi_freshness_seconds","utm_attribution_coverage"]
---
...
Default KPIs for this role: kpi_freshness_seconds, utm_attribution_coverage
