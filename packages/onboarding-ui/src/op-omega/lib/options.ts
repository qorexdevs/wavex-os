/** Static option lists for pillars 3, 4, 5. Mirrors upstream
 *  vendor/op-omega/ui-onboarding-components/onboarding/options.ts.
 *  `v` is the wire-format value; `l` is the operator-facing label. */
