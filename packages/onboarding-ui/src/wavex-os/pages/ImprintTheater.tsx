 ...
 *  acts after /wavex-os/onboarding/finalize returns:
...
import type { CompanyManifest, WorkflowManifest } from "@wavex-os/plugin-onboarding";
  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        const wfRes = await wavexOsOnboardingApi.generateWorkflow(companyId, {
          skipInference,
        ...
        try {
          const mc = await wavexOsOnboardingApi.getMcReport(companyId);
